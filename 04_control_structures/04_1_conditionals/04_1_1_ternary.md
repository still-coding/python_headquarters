[[04_1_0_if_else|← 🤔 Условный оператор if-else]] | [[04_2_0_for_loop| 🔁 Цикл for →]]
...
- [[04_1_0_if_else|Условный оператор if-else]]
- [[04_4_comprehensions|Включения (comprehensions)]] — часто используются вместе с тернарным оператором
