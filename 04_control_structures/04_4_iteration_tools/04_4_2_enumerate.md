[[04_4_1_range |← 🔢 range() — генерация числовых последовательностей]] | [[04_4_3_zip| 🤐 zip() — объединение последовательностей →]]
...
- [[04_3_1_for_loop|Цикл for]] — основное применение enumerate
- [[04_4_1_range|range()]] — для простой генерации индексов
- [[04_4_3_zip|zip()]] — для параллельной итерации по нескольким последовательностям
