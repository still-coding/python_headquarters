...
- [[04_3_1_for_loop|Цикл for]] — основное применение range
- [[04_4_2_enumerate|enumerate()]] — когда нужны и индексы, и значения
- [[04_5_comprehensions|Списковые включения]] — часто используется с range

## Следующий шаг

Изучите [[04_4_2_enumerate|enumerate()]] для одновременного получения индексов и значений при итерации.
