[[06_04_encapsulation|← 🔒 Инкапсуляция]] | [[06_06_polymorphism|🦆 Полиморфизм →]]
...
Множественное наследование мощное, но усложняет код — используйте осторожно. Альтернативу (композицию) разберём в файле [[06_09_composition_vs_inheritance|Композиция vs наследование]].
