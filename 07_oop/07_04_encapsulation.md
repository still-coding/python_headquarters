[[07_03_init_and_self|← 🔧 `__init__` и `self`]] | [[07_05_inheritance|🧬 Наследование →]]
...
- [[10_1_descriptors|Дескрипторы]] — то, как `@property` устроен под капотом. Если одна и та же валидация нужна для нескольких атрибутов, дескрипторы избавляют от копипаста.
