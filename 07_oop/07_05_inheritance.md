[[07_04_encapsulation|← 🔒 Инкапсуляция]] | [[07_06_polymorphism|🦆 Полиморфизм →]]
...
Множественное наследование мощное, но усложняет код — используйте осторожно. Альтернативу (композицию) разберём в файле [[07_09_composition_vs_inheritance|Композиция vs наследование]].

> 💡 Классический приём, делающий множественное наследование управляемым — **миксины**. О них: [[10_2_mixins|Миксины]].
...
- [[07_11_mro|MRO]] — как Python решает порядок вызовов при множественном наследовании
- [[07_09_composition_vs_inheritance|Композиция vs наследование]] — альтернатива, которая часто лучше
- [[10_2_mixins|Миксины]] — паттерн использования множественного наследования для добавления способностей
